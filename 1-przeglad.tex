...
Jednym z istotnych zagrożeń związanych ze stosowaniem suplementów diety jest kumulacja dawek składników pochodzących z różnych preparatów oraz produktów wzbogacanych. Jednoczesne stosowanie suplementów wieloskładnikowych, preparatów jednoskładnikowych oraz żywności wzbogacanej może prowadzić do nieświadomego przekroczenia zalecanych poziomów spożycia niektórych witamin i składników mineralnych. Szczególne znaczenie ma to w przypadku witaminy A, witaminy B6 oraz żelaza, dla których margines między zalecanym spożyciem a poziomem mogącym wywoływać działania niepożądane jest stosunkowo niewielka \cite{navarro2017liver}.
...
Podobne tendencje zaobserwowano w Serbii, gdzie 55,7\% studentów deklarowało stosowanie suplementów, głównie witamin i składników mineralnych. Co ciekawe, wyższy odsetek użytkowników odnotowano wśród studentów kierunków medycznych, co może wskazywać na większą dostępność informacji, ale niekoniecznie na bardziej krytyczne podejście \cite{serbian-undergraduate}.
